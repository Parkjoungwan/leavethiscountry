const TRANSLATIONS = {
  en: {
    ...
    from_usa: "USA", from_france: "France", from_tunisia: "Tunisia",
  ...
  ko: {
    ...
    from_usa: "미국", from_france: "프랑스", from_tunisia: "튀니지",
  ...
  zh: {
    ...
    from_usa: "美國", from_france: "法國", from_tunisia: "突尼西亞",
  ...
  hi: {
    ...
    from_usa: "अमेरिका", from_france: "फ्रांस", from_tunisia: "ट्यूनीशिया",
  ...
  ja: {
    ...
    from_usa: "アメリカ", from_france: "フランス", from_tunisia: "チュニジア",
